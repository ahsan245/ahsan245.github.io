...
function LoadAllComplain(Complaindata, Techniciandata)
{
    ...
    $.each(Complaindata, function (k, v) 
    {
        ...
        html +='<div>';
        html +='<img src="assets/img/team-2.jpg" class="avatar avatar-sm me-3" alt="user1">'; // baseUrl + v.complainImage
        html +='</div>';
        ...
        {
            html +='<span class="badge badge-sm bg-gradient-success">'+v.assignedTech+'</span>';
        }
        else
        {
            html += '<select id="allTechnicians-'+ k +'">';
